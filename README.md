...
|---------------------------|---------------|-----------------------------------------------|
| --file-format             | parquet       | `parquet` or `json`                           |
| --file-path               | /tmp/rotel    | Directory to place output files               |
| --file-flush-interval     | 5s            | How often to flush accumulated telemetry to a
